      ...
      <AnimatePresence mode="wait">
        {step !== 10 && (
          <motion.div
            ...
            className="relative w-full max-w-[480px] aspect-[0.84] xs:aspect-[0.92] sm:aspect-[1.1] bg-white rounded-2xl shadow-[0_24px_70px_rgba(0,0,0,0.08),_0_1px_3px_rgba(0,0,0,0.02)] border border-neutral-150 overflow-hidden flex flex-col font-sans select-none text-left"
          >
            {/* macOS Title Bar */}
