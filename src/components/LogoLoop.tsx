...
export type LogoItem = LogoItemWithNode | LogoItemWithSrc;
  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: string) => {
        if (renderItem) {
          return (
            <li className="logoloop__item animate-fade-in" key={key} role="listitem">
              {renderItem(item, key)}
            </li>
          );
        }
