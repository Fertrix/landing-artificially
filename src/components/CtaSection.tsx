...
const SlackLogo = () => (
  <svg className="w-5 h-5 sm:w-7 sm:h-7 text-neutral-900 fill-current" viewBox="0 0 24 24">
...
const VercelLogo = () => (
  <svg className="w-4 h-4 sm:w-6 sm:h-6 text-neutral-900 fill-current" viewBox="0 0 24 24">
...
const ReactLogo = () => (
  <svg className="w-5 h-5 sm:w-7 sm:h-7 fill-none stroke-current text-neutral-900" viewBox="0 0 24 24" strokeWidth="1.8">
...
const floatingCards = [
  ...
  { icon: SlackLogo, pos: 'top-[4%] left-[1%] sm:left-[4%] md:left-[6%]', rotate: -10, delay: 0 },
  { icon: GitHubLogo, pos: 'top-[26%] left-[2%] sm:left-[16%] md:left-[18%]', rotate: 12, delay: 0.1 },
  { icon: StripeLogo, pos: 'top-[48%] left-[1%] sm:left-[3%] md:left-[5%]', rotate: -5, delay: 0.2 },
  { icon: VercelLogo, pos: 'top-[70%] left-[2%] sm:left-[14%] md:left-[16%]', rotate: 8, delay: 0.3 },

  // Right side (4 cards: Linear, Raycast, OpenAI, React)
  { icon: LinearLogo, pos: 'top-[4%] right-[1%] sm:right-[4%] md:right-[6%]', rotate: 8, delay: 0.05 },
  { icon: RaycastLogo, pos: 'top-[26%] right-[2%] sm:right-[16%] md:right-[18%]', rotate: -12, delay: 0.15 },
  { icon: OpenAILogo, pos: 'top-[48%] right-[1%] sm:right-[3%] md:right-[5%]', rotate: -14, delay: 0.25 },
  { icon: ReactLogo, pos: 'top-[70%] right-[2%] sm:right-[14%] md:right-[16%]', rotate: 14, delay: 0.35 }
];
...
const FloatingCard: React.FC<FloatingCardProps> = ({ card, idx, isInView }) => {
  ...
  return (
    ...
    <motion.div
      ...
      className={`absolute ${card.pos} flex pointer-events-none select-none`}
    >
      ...
      <motion.div
        ...
        className="w-10 h-10 sm:w-16 sm:h-16 md:w-[4.5rem] md:h-[4.5rem] bg-white rounded-xl sm:rounded-2xl border border-black/[0.08] shadow-[0_8px_24px_-4px_rgba(0,0,0,0.06),0_2px_6px_-1px_rgba(0,0,0,0.03)] flex items-center justify-center cursor-default"
      >
        <IconComponent />
      </motion.div>
    </motion.div>
...
export const CtaSection: React.FC<CtaSectionProps> = ({ onApplyClick }) => {
  ...
  return (
    <div className="w-full">
      ...
      <section
        ref={sectionRef}
        className="relative w-full py-20 sm:py-24 md:py-36 px-2 sm:px-8 bg-white text-center overflow-hidden flex flex-col items-center justify-center min-h-[500px] sm:min-h-[580px]"
      >
        ...
        <motion.div
          ...
          className="relative z-20 max-w-[270px] xs:max-w-[310px] sm:max-w-3xl mx-auto flex flex-col items-center px-1 sm:px-0"
        >
          {/* Main Heading using site font-display */}
          <h2 className="font-display text-3xl sm:text-5xl md:text-6xl font-semibold text-neutral-900 tracking-tight leading-[1.12] mb-4 sm:mb-5">
            Revenue leaks are solved.
          </h2>

          {/* Subtitle */}
          <p className="text-neutral-500 text-xs sm:text-lg leading-relaxed font-medium tracking-tight mb-7 sm:mb-9 max-w-2xl">
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              type="button"
              className="inline-flex items-center gap-2 sm:gap-2.5 bg-[#18181b] hover:bg-black text-white text-xs sm:text-base font-medium px-5 sm:px-6 py-3 sm:py-3.5 rounded-xl transition-all shadow-md hover:shadow-lg cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
            >
